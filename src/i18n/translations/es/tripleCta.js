export default {
  ...
  emt: {
    title: 'Servicios Médicos de Emergencia (EMS)',
    content:
      'EMS es para emergencias, incluyendo dolor en el pecho, falta de aliento, pérdida del conocimiento, sangrado severo y huesos rotos. Para la mayoría de las otras cosas, una mejor opción puede incluir consultar a su médico de familia o usar el Centro de Salud Vecinal de Central Falls.',
    cta: `Obtenga más información sobre EMS<br>en Central Falls`,
